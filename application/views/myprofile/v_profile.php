...
<div class="content-wrapper">
  ...
  <div class="content-header">
    ...
    background-repeat: no-repeat;  " >
                ...
                <a href="<?php echo base_url('myprofile/ubahpassword'); ?>" class="btn btn-block <?php if($this->uri->segment(2) == 'ubahpassword') { echo 'btn-primary'; } else { echo 'btn-outline-primary'; } ?>"><b>Ubah Password</b></a>
